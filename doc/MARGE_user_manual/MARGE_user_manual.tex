...
\href{http://planets.ucf.edu/bart-docs/MARGE_user_manual.pdf}{http://planets.ucf.edu/bart-docs/MARGE_user_manual.pdf}.} 
...
increase the number of atmospheric layers (n_layers in BART config), and/or 
...
\item layers: strings. Type of each hidden layer.  
                       Options: dense, conv1d, maxpool1d, avgpool1d, flatten, 
                                dropout
\item lay_params: list. Parameters for each layer (e.g., kernel size). 
...
\item act_params: list. Parameters for each activation.  
